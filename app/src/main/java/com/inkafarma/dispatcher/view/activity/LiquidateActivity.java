...
public class LiquidateActivity extends BaseActivity {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(Color.parseColor("#31acd0"));
        }
    }
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(BarcodeResult result) {
            ...
            Toast.makeText(LiquidateActivity.this, lastText, Toast.LENGTH_LONG).show();
            ...
            if (Util.searchList(lastText, motorizedOrderModel)) {
                ...
                if (isContinue()) {
                    barcodeView.pause();
                    if (!isActivityShow(LiquidateActivity.this, ACTIVITY_CONFIRMATION)) {
                        Intent intent = new Intent(LiquidateActivity.this, ConfirmationActivity.class);
